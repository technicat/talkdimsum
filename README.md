...
The list was originally just in the US (actually, just Las Vegas), but someone from Canada complained (the reputation of Canadians for politeness is really exaggerated), so now I try to get all countries in, except for some that I'm excluding on the App Store based on current or recent [genocidal practices]([club](https://www.genocidewatch.com/countries-at-risk)), such as [China](https://en.wikipedia.org/wiki/Uyghur_genocide), [Myanmar](https://www.state.gov/burma-genocide/) (I didn't really want to try entering every dim sum eatery in China, anyway), [Russia](https://www.usip.org/publications/2022/09/russia-committing-genocide-ukraine) (I don't know if there's dim sum in Russia), and [Saudi Arabia](https://www.genocidewatch.com/single-post/genocide-emergency-saudi-arabia-and-the-war-in-yemen) (yes, there's dim sum in Saudi Arabia).
